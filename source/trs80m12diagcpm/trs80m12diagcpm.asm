...
;
                ...
                .org  0f000h                            ; z80 boot code starts at location 0
start:
                di                                      ; mask INT
                im      1
                ld      a,1
...
msg_dash:       dbz     "-"
msg_space:      dbz     " "
msg_banner:     dbiz    "TRS-80 M12/M16B Banked CPM Memory Test - Frank / Dave / Black"
msg_testok:     dbz     " --OK-- "
; msg_reloc:    dbz     "(reloc) "
...
tp_vram:        db      high VSIZE, high VBASE, $1, label_vram-labels_start
                dw      VBASE+( 2*VLINE)+COL1

tp_low:         db      $40, $80, $1, label_dram16-labels_start
                dw      VBASE+( 4*VLINE)+COL1
tp_rdest:       db      $30, $C0, $1, label_dram16-labels_start
                dw      VBASE+( 3*VLINE)+COL1

tp_high:        db      $40, $00, $0, label_bank16-labels_start
                dw      VBASE+( 5*VLINE)+COL1
                db      $40, $40, $0, label_bank16-labels_start
                dw      VBASE+( 6*VLINE)+COL1
                db      $40, $00, $2, label_bank16-labels_start
                dw      VBASE+( 7*VLINE)+COL1
                db      $40, $40, $2, label_bank16-labels_start
                dw      VBASE+( 8*VLINE)+COL1
                db      $40, $00, $3, label_bank16-labels_start
                dw      VBASE+( 9*VLINE)+COL1
                db      $40, $40, $3, label_bank16-labels_start
                dw      VBASE+(10*VLINE)+COL1
                db      $40, $00, $4, label_bank16-labels_start
                dw      VBASE+(11*VLINE)+COL1
                db      $40, $40, $4, label_bank16-labels_start
                dw      VBASE+(12*VLINE)+COL1
                db      $40, $00, $5, label_bank16-labels_start
                dw      VBASE+(13*VLINE)+COL1
                db      $40, $40, $5, label_bank16-labels_start
                dw      VBASE+(14*VLINE)+COL1
                db      $40, $00, $6, label_bank16-labels_start
                dw      VBASE+(15*VLINE)+COL1
                db      $40, $40, $6, label_bank16-labels_start
                dw      VBASE+(16*VLINE)+COL1
                db      $40, $00, $7, label_bank16-labels_start
                dw      VBASE+(17*VLINE)+COL1
                db      $40, $40, $7, label_bank16-labels_start
                dw      VBASE+(18*VLINE)+COL1
                db      $40, $00, $8, label_bank16-labels_start
                dw      VBASE+( 3*VLINE)+COL2
                db      $40, $40, $8, label_bank16-labels_start
                dw      VBASE+( 4*VLINE)+COL2
                db      $40, $00, $9, label_bank16-labels_start
                dw      VBASE+( 5*VLINE)+COL2
                db      $40, $40, $9, label_bank16-labels_start
                dw      VBASE+( 6*VLINE)+COL2
                db      $40, $00, $A, label_bank16-labels_start
                dw      VBASE+( 7*VLINE)+COL2
                db      $40, $40, $A, label_bank16-labels_start
                dw      VBASE+( 8*VLINE)+COL2
                db      $40, $00, $B, label_bank16-labels_start
                dw      VBASE+( 9*VLINE)+COL2
                db      $40, $40, $B, label_bank16-labels_start
                dw      VBASE+(10*VLINE)+COL2
                db      $40, $00, $C, label_bank16-labels_start
                dw      VBASE+(11*VLINE)+COL2
                db      $40, $40, $C, label_bank16-labels_start
                dw      VBASE+(12*VLINE)+COL2
                db      $40, $00, $D, label_bank16-labels_start
                dw      VBASE+(13*VLINE)+COL2
                db      $40, $40, $D, label_bank16-labels_start
                dw      VBASE+(14*VLINE)+COL2
                db      $40, $00, $E, label_bank16-labels_start
                dw      VBASE+(15*VLINE)+COL2
                db      $40, $40, $E, label_bank16-labels_start
                dw      VBASE+(16*VLINE)+COL2
                db      $40, $00, $F, label_bank16-labels_start
                dw      VBASE+(17*VLINE)+COL2
                db      $40, $40, $F, label_bank16-labels_start
...
tp_low_reloc:   db      $40, $80, $1, label_dram16-labels_start
                dw      VBASE+( 4*VLINE)+COL1
